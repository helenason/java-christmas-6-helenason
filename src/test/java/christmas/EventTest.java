...
public class EventTest {
    ...
    void calculateChristmasDiscount(int date) {
        ...
        assertThat(discountAmount).isEqualTo(1000 + (date - 1) * 100);
    }
    ...
    void calculatePresentDiscount() {
        ...
        int discountAmount = presentEvent.calculate(150000, 15);
    ...
    void calculatePresentDiscountLess() {
        ...
        int discountAmount = presentEvent.calculate(100000, 15);
    ...
    void getSantaEventBadge(int benefitAmount) {
        ...
        String badge = badgeEvent.calculate(benefitAmount, 15);
